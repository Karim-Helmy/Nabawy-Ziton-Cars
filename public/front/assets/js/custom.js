	...
	var headerFix = function(){
		...
		jQuery(window).on('scroll', function () {
			...
			if ($(window).scrollTop() > menu.offset().top) {
				...
				$('.logo').attr('src','https://high-discounts.net/nabawy/public/front/assets/images/logo-light1.png');
			} else {
				menu.removeClass('is-fixed');
				$('.logo').attr('src','https://high-discounts.net/nabawy/public/front/assets/images/logo-light.png')
			}
		});
