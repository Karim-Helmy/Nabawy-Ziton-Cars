...
<div class="login-box">
  <div class="login-logo">
   	<img src="<?php echo e(url('public/front/assets/images/logo-light.png')); ?>" class="ionic-hide">

    <div style="
    font-size: 25px;
"><b> <?php echo e(trans('labels.welcome_message')); ?></b>TO<b> <?php echo e(trans('labels.welcome_message_nabawy')); ?></b> Admin Panel</div>
  </div>
  <!-- /.login-logo -->
