<?php
	/*
	Project Name: Nabawy Motors
	Project URI:
	Author: Karim Helmy
	Author URI: http://port.byethost31.com/
	Version: 2.1
	*/
...
|--------------------------------------------------------------------------
|
| This section contains all Front-End Routes
|
|
*/
//////// SingleTon Start
...
/**
 * ==========================
 * Brands And Products Starts 
 * ==========================
 */
	Route::get('/brands', 'BrandsController@index');
	Route::get('/brands/{id}', 'BrandsController@single_brand');
	Route::get('/brands/{brand_id}/product/{product_id}', 'BrandsController@single_product');
/**
 * ==========================
 * Brands And Products Ends 
 * ==========================
 */

/**
 * ==================================
 * Cars Price Page With Ajax Starts
 * ==================================
 */
	Route::get('/cars-prices', 'CarPriceController@index');
	Route::post('/single-brand-data', 'CarPriceController@single_brand_cars');
/**
 * ==================================
 * Cars Price Page With Ajax Ends
 * ==================================
 */
    /**
     * ==================================
     ...
     * ==================================
     */
    Route::get('/used', 'BrandsController@used');
    ...
    /**
 * ==================================
 * Cars Installment With Ajax Starts
 * ==================================
 */	
	Route::get('calculate-installment', 'CalculateInstallment@index'); 
	Route::post('get_products_car_installment', 'CalculateInstallment@SubCategories'); 
	Route::post('products_in_sub_category', 'CalculateInstallment@Products_IN_SubCategory');
/**
 * ==================================
 * Cars Installment With Ajax Ends
 * ==================================
 */	
 ...
 */	
	...
	Route::get('/singelnews/{id}', 'NewsController@single');
/**
 * ==================================
 * News Ends
 * ==================================
 */
    ...
    Route::get('/singleinsurance/{id}', 'InsuranceController@single')->name('single_insurance');
    /**
     * ==================================
     * insurance Ends
     * ==================================
     */
	  ...
	  */
		...
		Route::get('/advanced-search', 'SearchController@advanced')->name('advanced_search');
		Route::post('/get_categories', 'SearchController@getCategories'); 
		// Route::post('get')
	 ...
	 * ==========================
	 */
		Route::get('/{page_name}', 'PagesController@page');
	/**
	 * ==========================
	 * Dynamic Pages Ends
	 * ==========================
...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		*/
           ...
           //Insurance
            Route::get('/listingInsurance', 'AdminInsuranceController@listingCountries');
            Route::get('/addInsurance', 'AdminInsuranceController@addCountry');
            Route::post('/addNewInsurance', 'AdminInsuranceController@addNewCountry');
            Route::get('/editInsurance/{id}', 'AdminInsuranceController@editCountry');
            Route::post('/updateInsurance', 'AdminInsuranceController@updateCountry');
            Route::post('/deleteInsurance', 'AdminInsuranceController@deleteCountry');
