                    ...
                    <div class="col-md-12 text-right" style="direction:rtl;">
                        ...
                        <div class="icon-bx-wraper bx-style-1 m-b30" >
                            ...
                            <div class="img text-center" id="loader">
                                <img src=" {{ asset('/')."public/front/assets/images/lg.dual-ring-loader.gif" }} " alt="">
                            </div>
                            ...
                            <table class="table-dl table-col4 clearfix" id="cars_prices">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>  
                                            <a data-fancybox-trigger="gallery" href="{{ asset('/').$product->products_image }}" data-fancybox="images"> 
                                                <img src=" {{ asset('/').$product->products_image }} " alt=" {{ $product->categories_name }} " style="height: 60px!important;margin: auto;display: block;"> 
                                            </a> 
                                        </td>
                                        ...
                                        <td>
                                            <button class="btn btn-success calculate_installment" value="{{ $product->products_price }}" data-toggle="modal" data-target="#myModal"> تفاصيل القسط </button>
                                        </td>
                                    
                                        <td>  {{ (int)$product->products_price }} جنية  </td>
                                    
                                        <td>
                                            {{ date('d M, Y', strtotime(($product->products_last_modified))) }}
                                        </td>
                ...
                "</thead>" ;
                   for (let index = 0; index < data.length; index++) {
                    ...
                    "<tr>" + 
                        ...
                        "<td>" +  
                            "<a "+ 
                            " href=" + "'" + "{{ asset('/') }}"+ data[index].categories_image + "'"+  
                            "target=" + "'_blank'" +
