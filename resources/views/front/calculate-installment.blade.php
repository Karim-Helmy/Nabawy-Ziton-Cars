                    ...
                    <div class="icon-bx-wraper bx-style-1 p-a20 m-b30">
                        ...
                        <form class="row" method="POST">
                            ...
                            <div class="col-md-3 col-sm-3 col-lg-12 m-b20">
                                <select class="form-control{{--  bs-select-hidden --}}" id="categories">
                    ...
                    <div class="icon-bx-wraper bx-style-1 p-a20 m-b30">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-12 col-sm-12 col-lg-12 m-b20 form-group text-right ">
                                <img
                                        src=" {{ asset('/')."public/front/assets/images/success-png-success-icon-image-23194-400.png" }} "
                                        alt=""
...
@section('custome_js')
    ...
    <script>
        ...
        $("#nxt1").on('click', function(e){
            ...
            $.ajax({
                method: "POST",
                url: " {{ url('get_products_car_installment') }} " ,
                data: {
                    _token : _token ,
