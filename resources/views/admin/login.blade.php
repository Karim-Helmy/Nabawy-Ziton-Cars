...
<div class="login-box">
  <div class="login-logo">
   	<img src="{{url('public/front/assets/images/logo-light.png')}}" class="ionic-hide">

    <div style="
    font-size: 25px;
"><b> {{ trans('labels.welcome_message') }}</b>TO<b> {{ trans('labels.welcome_message_nabawy') }}</b> Admin Panel</div>
  </div>
  <!-- /.login-logo -->
